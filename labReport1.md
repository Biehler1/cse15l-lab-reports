...
Additionally, when I ran cd with another folder argument (Ex: "cd messages"), my workingn directory was changed to messages (as seen by `[user@sahara ~/lecture1/messages]`)
This was not an error.
